...
- Support multiple input views (Entry, Editor, Picker)
...
- **Multiple Input Views** — Entry, Editor, Picker, DatePicker, TimePicker, Masked Entry, Numeric Entry
...
- Handler registration (`ConfigureSyncfusionToolkit`)
...
- Supported input views (Entry, Editor, etc.)
